const algorithmsMetadata = {
    ...
    slug: 'bubble-sort',
    type: 'sorting',
    description: 'Repeatedly steps through the array, compares adjacent elements, and swaps them if they are in the wrong order. The pass through the array is repeated until no swaps are needed.',
    timeComplexity: { best: 'O(n)', average: 'O(n²)', worst: 'O(n²)' },
    spaceComplexity: 'O(1)',
    stable: true,
    bestUse: 'Small datasets or nearly sorted arrays.',
